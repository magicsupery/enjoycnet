	...
	namespace net
	{
		...
		class Codec
		{
			public:
				...
				virtual size_t parse_message(const char* data, size_t len) = 0;
		...
		class HttpServerCodec: public Codec<HttpRequest, HttpResponse>
		{
			public:
				...
				virtual size_t parse_message(const char* data, size_t len) override
				{
		...
		class HttpClientCodec: public Codec<HttpResponse, HttpRequest>
		{
			public:
				...
				size_t parse_message(const char* data, size_t len)
				{
